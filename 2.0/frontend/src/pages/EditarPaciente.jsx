...
export default function EditarPaciente() {
    ...
    try {
      ...
      const nextForm = {
        ...
        fecha_nacimiento: paciente.fecha_nacimiento
          ...
          : "",
        provincia_id: paciente.provincia_id ? String(paciente.provincia_id) : "",
      ...
      setLoadError(error.message || "No se pudo cargar el paciente.");
    } finally {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setSubmitError(error.message || "No se pudo actualizar el paciente.");
    } finally {
      setGuardando(false);
    }
  };
  ...
  const canSubmit =
    !guardando && !loadingPaciente && !loadingProvincias && !loadError && isDirty;
    ...
    <div className="registro-paciente-page">
      <div className="registro-paciente-shell">
        <div className="registro-paciente-header">
          <div>
            <span className="registro-badge">Editar paciente</span>
            <h1>Actualizar paciente</h1>
            <p>Modifica los datos del paciente y guarda los cambios en Turnify.</p>
          </div>
        ...
        {!loadingPaciente && !loadError ? (
          <section className="registro-section registro-summary-card">
            ...
            <div className="registro-summary-content">
              <span className="registro-summary-label">Paciente en edicion</span>
              <h2>{nombreCompleto || "Paciente sin nombre"}</h2>
              <p>
                {form.dni ? `DNI ${form.dni}` : "Completa los datos identificatorios"} ·{" "}
        ...
        {loadingPaciente ? (
          <section className="registro-section registro-feedback-card">
            <div className="section-heading">
              ...
              <p>Estamos trayendo la informacion del paciente para editarla.</p>
            </div>
          ...
          <section className="registro-section registro-feedback-card">
            ...
            <div className="registro-actions">
              <button type="button" className="btn-primary" onClick={cargarPaciente}>
                Reintentar
              </button>
              <button
                type="button"
              ...
              <div className="registro-grid">
                ...
                <div className="field">
                  ...
                  <select
                    ...
                    disabled={!form.provincia_id || loadingLocalidades || guardando}
                  >
                    <option value="">
                      {!form.provincia_id
